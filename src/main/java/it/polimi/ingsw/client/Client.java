...
public class Client {
    ...
    /**
     * This is the method for receive data from the. socket.
     * It should print the battlefield when it receive one
     * @param socketIn data stream in input
     * @return the tread ??? what is this?
     */
